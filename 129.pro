...
datafile='129_eve_2014-10-29T095400.dat'	
...
tstart = '09:58:05 29-OCT-14'
tend = '10:00:30 29-OCT-14'
...
dt=tai[ n_elements(x)/2]-tai[ n_elements(x)/2 -1]
					; CADENCE FOUND AT HALF WAY THROUGH DATASET INCASE CAD CHANGES DUE TO
...
!p.charthick = 1
!p.multi = [0,2,2]
utplot, t, x, ystyle = 1, ytitle = 'EVE Signal'					; LIGHTCURVE OF 'INPUT' DATA AND TREND
...
outplot, t, emd_clean, color =64, thick =6
!p.multi = 0
device, /close
set_plot, 'X'
