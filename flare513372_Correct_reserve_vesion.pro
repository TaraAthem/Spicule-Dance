...
;set_plot, 'PS'
;device, filename='513372_1.eps', encapsulated=1,$		;DEFINES FILENAME AND IMAGE PROPERTIES
...
modes=emd(x_pre-mean(x_pre), shiftfactor=0.0015, epsilon=1d-4, maxsiftings=1d5)
sz=size(modes)
...
plot,EXP(-freq_post), pow_post,title='Fourier Spectrum - Postflare', xtitle=$   ;FOURIER POWER SPECTRUM
  'Period [s]', ytitle='Log Fourier power [a.u.]', /xstyle, $
  /ystyle, charsize=ch, /xlog, xrange=[2,100], yrange=[-6.5, 2.7], thick=2
...
plot,[0],[0],charsize=ch,/xsty,/ysty,yrange=[-10,20],xrange=[0,300],$   ;ORIGINAL SIGNAL WINDOW
  title='Profile of Flare 513372', xtitle='Elapsed Time [s]',ytitle='Amplitude'
