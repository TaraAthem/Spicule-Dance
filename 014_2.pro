...
datafile='014_goes_2014-10-14T18:12:00_2014-10-14T19:01:00.dat'	
...
tstart='18:12:00 14-OCT-14'
tend='19:00:59 14-OCT-14'
...
set_plot, 'PS'
device, filename=path + '/Spectra/Time_plots/'+ flarenum[0]+'_'+flarenum[1]+'_TIMEPLOTS_2.eps', encapsulated=1,/color,bits=24 
loadct,39
!p.BACKGROUND =255
!p.color = 0
!p.charsize = 1
...
tstart='18:29:00 14-OCT-14'
tend='18:48:00 14-OCT-14'
...
set_plot, 'PS'
device, filename=path + '/Spectra/'+ flarenum[0]+'_'+flarenum[1]+'_2.eps', encapsulated=1,/color,bits=24, xsize=100, ysize=55
...
cad=dt
energy=sp.energy
save,mode1, trend,sig_orig,time,cad,periods,Q,mod_depth,dur,energy,conf95,conf99,avg_energy,per_arr,emin, emax,FILENAME=path + '/Sav_files/'+flaresav+'_2.sav'
