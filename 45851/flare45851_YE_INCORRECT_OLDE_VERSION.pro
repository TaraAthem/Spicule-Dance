...
set_plot, 'PS'
device, filename='45851_1.eps', encapsulated=1,$		;DEFINES FILENAME AND IMAGE PROPERTIES
...
confn1_95_pre=emd_noise_conf(N_pre, alpha_1, nsamples=80l, confidence_level = 0.05d)
confn1_99_pre=emd_noise_conf(N_pre, alpha_1, nsamples=80l, confidence_level = 0.01d)
...
confn2_95_pre=emd_noise_conf(N_pre, alpha_2, nsamples=80l, confidence_level = 0.05d)
confn2_99_pre=emd_noise_conf(N_pre, alpha_2, nsamples=80l, confidence_level = 0.01d)
...
;#0.76 was good
modes=emd(x_flare-mean(x_flare), shiftfactor=0.0088, epsilon=1d-4, maxsiftings=1d5)
sz=size(modes)
...
confn1_95_flare=emd_noise_conf(N_flare, alpha_1, nsamples=80l, confidence_level = 0.05d)
confn1_99_flare=emd_noise_conf(N_flare, alpha_1, nsamples=80l, confidence_level = 0.01d)
...
confn2_95_flare=emd_noise_conf(N_flare, alpha_2, nsamples=80l, confidence_level = 0.05d)
confn2_99_flare=emd_noise_conf(N_flare, alpha_2, nsamples=80l, confidence_level = 0.01d)
...
confn1_95_post=emd_noise_conf(N_post, alpha_1, nsamples=80l, confidence_level = 0.05d)
confn1_99_post=emd_noise_conf(N_post, alpha_1, nsamples=80l, confidence_level = 0.01d)
...
confn2_95_post=emd_noise_conf(N_post, alpha_2, nsamples=80l, confidence_level = 0.05d)
confn2_99_post=emd_noise_conf(N_post, alpha_2, nsamples=80l, confidence_level = 0.01d)
