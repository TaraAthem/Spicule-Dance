...
set_plot, 'PS'
device, filename='389761_1.eps', encapsulated=1,$		;DEFINES FILENAME AND IMAGE PROPERTIES
...
modes=emd(x_pre-mean(x_pre), shiftfactor=0.215, epsilon=1d-4, maxsiftings=1d5)
sz=size(modes)
...
plot,[0],[0],charsize=ch,/xsty,/ysty,yrange=[-10,20],xrange=[0,300],$   ;ORIGINAL SIGNAL WINDOW
  title='Profile of Flare 389761', xtitle='Elapsed Time [s]',ytitle='Amplitude'
oplot,tim_flare,trend_emd_flare + 1. ,color=130,thick=4
oplot,tim_flare, x_flare+trend_emd_flare + 1.,thick=3
...
oplot,tim_pre, x_pre+trend_emd_pre + 1.
oplot,tim_pre,trend_emd_pre + 1. ,color=50,thick=4	 ;200 is yelow, 150 is lime green, 250 red, 50 lbue
...
oplot,tim_post, x_post+trend_emd_post + 1.,thick=3
