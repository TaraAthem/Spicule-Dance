...
datafile='077_goes_2014-10-23T17:42:00_2014-10-23T18:43:00.dat'	
channel=3
;FOR GOES DATA
...
tstart='17:42:00 23-OCT-14'
tend = '18:43:00 23-OCT-14'
...
tstart='17:50:10 23-OCT-14'
tend = '17:53:30 23-OCT-14'
...
IF (maxemd eq 0) and (LOOP eq 'Y') THEN GOTO, LABEL1					; THIS ENSURES THE PROGRAM CONTINUES RUNNING UNTIL A SIG IMF IS FOUND 
											; FOR A GIVEN SF-THIS MAY NOT ;-----multimodal
mode1=  modes[*,2]
mode2= modes[*,3]
;--------------
trend=trend_emd
