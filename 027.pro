...
datafile='027_norh_2014-10-18T00:55:00.dat'
...
tstart = '01:06:00 18-OCT-14'
tend   = '01:11:00 18-OCT-14'
...
trend_emd = mean(x) + modes[*,-1]+ modes[*,-2]+ modes[*,-3]+ modes[*,-4]
...
IF (channel eq 2) THEN print,'This flare was detected by NoRH' ELSE print, 'Something went wrong. Check channel number.'
