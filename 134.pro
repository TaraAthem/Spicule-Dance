...
datafile='134_goes_2014-10-29T19:32:00_2014-10-29T20:19:00.dat'	
channel=4
...
tstart='19:32:00 29-OCT-14'
tend = '20:19:00 29-OCT-14'
...
sets=2.										;Determines how many evenly 												; sized samples you want to break 												;the signal into. Default is 10. 
...
cad=dt
energy=sp.energy
save,mode1, mode2,mode3, trend,sig_orig,time,cad,periods,Q,mod_depth,dur,energy,conf95,conf99,avg_energy,per_arr,emin, emax,FILENAME=path + '/Sav_files/'+flaresav+'.sav'
